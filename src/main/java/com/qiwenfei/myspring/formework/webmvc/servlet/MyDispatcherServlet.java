...
import com.qiwenfei.myspring.formework.aop.MyAopProxyUtils;
import com.qiwenfei.myspring.formework.context.MyApplicationContext;
    ...
    private void initHandlerMappings(MyApplicationContext context) {
        ...
        try {
            for (String beanName : beanNames) {
                ...
                Object controller = MyAopProxyUtils.getTargetObject(proxy);
